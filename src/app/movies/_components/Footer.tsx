      ...
      <div className="max-w-[1440px] mx-auto flex flex-col gap-10 md:flex-row md:justify-between">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col ">
              <p>Email:</p> support@movieZ.com
            </div>
          </div>
          <div className="flex items-center gap-2">
            <Phone className="w-5 h-5" />
            <div className="flex flex-col">
              <p>Phone:</p> +976 (11) 123-4567
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-4 text-sm ">
          ...
          <div className="flex  gap-2 md:gap-3">
            ...
            <a href="https://x.com/pinecone" target="_blank">
              Twitter
            </a>
            <a href="https://www.youtube.com/@PineconeAcademy" target="_blank">
              YouTube
            </a>
          </div>
        </div>
